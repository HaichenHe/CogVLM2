python -W ignore -u generate_prompts/tools/run_generate.py \
  ...
  --opts DATA.PATH_TO_DATA_DIR /opt/data/private/hhc/workdir/CogVLM2/generate_prompts/split_19 \
  OUTPUT_GENERATE_PROMPT /opt/data/private/hhc/workdir/CogVLM2/generate_prompts/split_19/split_19_prompts.json \
