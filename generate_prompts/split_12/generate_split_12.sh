python -W ignore -u generate_prompts/tools/run_generate.py \
  --init_method tcp://localhost:10010 \
  --cfg generate_prompts/TemporalCLIP_vitb16_8x16_STAdapter.yaml \
  --opts DATA.PATH_TO_DATA_DIR /opt/data/private/hhc/workdir/CogVLM2/generate_prompts/split_12 \
  OUTPUT_GENERATE_PROMPT /opt/data/private/hhc/workdir/CogVLM2/generate_prompts/split_12/split_12_prompts.json \
